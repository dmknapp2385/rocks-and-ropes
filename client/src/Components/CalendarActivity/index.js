...
const CalendarActivity = ({ activity, setActivities, activities, days, detailModalProps}) => {
    ...
    return (
        <div className="activity border border-dark rounded m-2 text-center background-tan" >
            ...
            <div className="m-2">
                <Button variant="secondary" className="detail"><FontAwesomeIcon icon={faPlus} onClick={handleDetailClick} /></Button>
                <Button variant = "secondary" className="delete"><FontAwesomeIcon icon={faTrashCan} onClick={handleDeleteClick} /></Button>
            </div>
        </div>
    );
}
